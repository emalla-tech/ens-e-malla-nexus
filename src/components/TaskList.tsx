                ...
                <td className="sticky right-0 bg-white px-5 py-4 shadow-[-8px_0_12px_-12px_rgba(17,17,17,0.35)]">
                  <div className="flex justify-end gap-2">
                    <Button
                      type="button"
                      variant="secondary"
                      className="h-9 border border-emerald-200 bg-emerald-50 px-3 text-emerald-700 ring-0 hover:bg-emerald-100"
                    ...
                    <Button
                      type="button"
                      variant="secondary"
                      className="h-9 border border-gray-300 px-3 ring-0"
                      onClick={() => onEdit(task)}
                    ...
                    <Button
                      type="button"
                      variant="danger"
                      className="h-9 border border-red-200 px-3"
